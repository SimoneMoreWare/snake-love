...
import { NUM_ROWS, NUM_COLS, CELL_SIZE, calculateOptimalCellSize } from './constants.mjs';
...
export function adjustStyles() {
  ...
  const fontSize = Math.max(1, Math.min(window.innerWidth, window.innerHeight) * 0.03);
